...
Phase 10 已收口为 **`pixel-phase-10` — 支线奖励房间**。当前下一阶段建议进入 **Phase 11 — 旧地图清理或钥匙门**：

1. 清理旧 MapScreen，或把它改成明确的调试视图。
2. 加入钥匙门或更多可选分支，但仍复用现有节点结算。

### 5.2 已知风险与未决问题

| 风险 / 未决项 | 影响 | 处理建议 |
|---|---|---|
| 地牢路径仍以 route 主线为核心 | Phase 10 已有一个支线，但探索感仍有限 | 后续可加钥匙门或更多可选分支，不要直接上随机大地图。 |
