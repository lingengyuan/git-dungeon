...
如果地牢层直接把 HP 扣到 0，就需要新增地牢层 Game Over 流程。Phase 9 先把陷阱定义为消耗压力，不抢战斗/结算层职责。
...
- **禁止掩盖性质 fallback**：陷阱触发显示真实 HP 损失，重复触发显示已触发。
