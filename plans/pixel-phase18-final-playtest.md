...
| PX-020 | 已关闭 | Phase 22 已完成后台加载、进度提示和 Esc/Q 取消回标题页。 |
...
| PX-036 | 移出范围 | 用户已明确当前只支持 PC，不考虑手柄支持。 |
| PX-037 | 已关闭 | 已支持文字大小、高对比、减少动画基础选项。 |
| PX-038 | 已关闭 | BGM 完成响度统一、循环策略和用途记录。 |
| PX-039 | 已关闭 | Phase 23 已完成地牢页近期事件日志和房间进度摘要。 |
| PX-040 | 已关闭 | Phase 19 已完成 PC 键鼠首次游玩教学。 |
