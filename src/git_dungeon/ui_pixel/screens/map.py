...
class MapScreen(Screen):
    ...
    def draw(self, surface: Any) -> None:
        ...
        self.fonts.draw(surface, "ROUTE", (12, 8), ACCENT, 22)
        self.fonts.draw(surface, self.message[:34], (82, 12), MUTED, 15)
        ...
        self.fonts.draw(surface, f"Gold {player.gold}", (204, 54), TEXT, 14)
    ...
    def _current_button(self) -> Button:
        ...
        if current:
            label = f"Open {current.kind.title()}"
