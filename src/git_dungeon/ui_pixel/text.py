...
PIXEL_TEXT = {
    "zh_CN": {
        ...
        "Enter/Esc: Back": "确认/Esc 返回",
        "Reading git history...": "正在读取提交历史...",
        "Preparing run...": "正在准备本局...",
        "Building dungeon route...": "正在生成地牢路线...",
        "Still working on this repository...": "仓库较大，仍在处理...",
        ...
        "Press Q again to return to title": "再次按 Q 回到标题页",
        "Settings open over the paused run": "设置会覆盖在暂停页上",
        "BATTLE": "战斗",
        "ELITE": "精英",
        "BOSS": "首领",
        "Turn": "回合",
        ...
        "SETTINGS": "设置",
        "FIRST RUN": "首次游玩",
        "Learn the PC controls before entering the run": "进入地牢前先看键鼠操作",
        "Move: arrows, WASD, or click next room": "移动：方向键/WASD/点击相邻房",
        "Confirm: enter glowing rooms and choose": "确认：进入发光房间并选择",
        "Pause: Esc/Q; traps hurt, caches help": "暂停：Esc/Q；陷阱扣血，补给有用",
        "Start Run": "开始本局",
        "Save tutorial state failed": "保存教学状态失败",
        "BGM Volume": "音乐音量",
        "SFX Volume": "音效音量",
        "Language": "语言",
        "Window": "窗口",
